...
=======
        raise OptionError(
            "Value for option {} must be one of {}".format(
...
=======
        raise OptionError(
            f"Invalid type {string!r} for option {optname}; use "
            "1/0, yes/no, true/false, on/off"
        )
    elif string.lower() in ("1", "yes", "true", "on"):
>>>>>>> f3a69242bb20942eb83b5471dc20cc8ed3b34b24
...
=======
        raise OptionError(
            f"Invalid type {string!r} for option {optname}; you "
            "must give an integer value"
        )
    except ValueError:
        raise OptionError(
...
=======
        raise OptionError(
            f"Invalid type {val!r} for option {optname}; you " "must give a list value"
        )
>>>>>>> f3a69242bb20942eb83b5471dc20cc8ed3b34b24
